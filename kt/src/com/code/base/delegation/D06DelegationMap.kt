...
class D06DelegationMapStudent(map: Map<String, Any?>) {
...
// 读写map
class D061DelegationMapStudent(map: MutableMap<String, Any?>) {
    var address: String by map
}

fun main(args: Array<String>) {
    val student = D06DelegationMapStudent(mapOf(
            "name" to "zhangsan",
            "address" to "beijing",
            "age" to 20,
            "birthday" to Date()
    ...
    val student2 = D061DelegationMapStudent(map)
