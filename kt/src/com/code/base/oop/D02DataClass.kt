...
/*
    ...
    1. equals/hashCode对。
    2. toString()方法，形式为D02Person(name=..., age=..., address=...)
...
data class D02Person(val name: String, var age: Int, var address: String) {

}

fun main(args: Array<String>) {
    val person = D02Person("Jack", 20,"beijing")
    val olderJack =  person.copy(address = "hangzhou")
